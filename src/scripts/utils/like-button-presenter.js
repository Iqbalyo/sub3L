import { createLikeRestaurantButtonTemplate, createUnLikeRestaurantdButtonTemplate} from '../views/templat/template-creator';
...
const LikeButtonPresenter = {
  ...
  _renderLiked() {
    this._likeButtonContainer.innerHTML = createUnLikeRestaurantdButtonTemplate();
